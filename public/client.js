...
(function() {
  ...
  function setupRoleBadge() {
    ...
    badge.textContent = '온라인 · 내 색: ' + role.name;
    ...
    badge.innerHTML = '<span style="display:inline-block;width:12px;height:12px;border-radius:999px;background:' + role.color + ';border:1px solid rgba(255,255,255,.45);"></span>' + badge.textContent;
