...
(function() {
  ...
  function getSnapshotEndMessage(snapshot) {
    ...
    if ((currentGame === 'axis4' || currentGame === 'gomoku' || currentGame === 'dab' || currentGame === 'blokus' || currentGame === 'orbito' || currentGame === 'halma') && typeof gameState.winner === 'number') {
  ...
  function finalizeOnlineGame(payload) {
    ...
    const tone = warningReasons.includes(endReason) ? 'warning' : (endReason === 'room_closed' ? 'info' : 'success');
